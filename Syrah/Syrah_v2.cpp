...
if(debug == 1) { cout<< "groupCodes MATRIX" <<endl; cout<< groupCodes <<endl; }
  temp_CatCV.allocate("temp_CatCV");
  temp_EscCV.allocate("temp_EscCV");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  #ifndef NO_AD_INITIALIZE
  temp_sigmaCat.initialize();
  #endif
  temp_sigmaEsc.allocate("temp_sigmaEsc");
  #ifndef NO_AD_INITIALIZE
  temp_sigmaEsc.initialize();
  #endif
  ...
  NLLextra.initialize();
  #endif
  ageCompCatchoff.allocate("ageCompCatchoff");
  #ifndef NO_AD_INITIALIZE
  ageCompCatchoff.initialize();
  #endif
  ageCompEscoff.allocate("ageCompEscoff");
  #ifndef NO_AD_INITIALIZE
  ageCompEscoff.initialize();
  #endif
  geneticsoff.allocate("geneticsoff");
  #ifndef NO_AD_INITIALIZE
  geneticsoff.initialize();
  #endif
